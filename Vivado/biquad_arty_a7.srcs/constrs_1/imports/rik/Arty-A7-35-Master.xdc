...
#set_property -dict { PACKAGE_PIN E15   IOSTANDARD LVCMOS33 } [get_ports { MCLK_FSEL }]; #IO_L11P_T1_SRCC_15 Sch=jb_p[1]
#set_property -dict { PACKAGE_PIN E16   IOSTANDARD LVCMOS33 } [get_ports { SCL }]; #IO_L11N_T1_SRCC_15 Sch=jb_n[1]
...
#set_property -dict { PACKAGE_PIN J18   IOSTANDARD LVCMOS33 } [get_ports { SDA }]; #IO_L23N_T3_FWE_B_15 Sch=jb_n[3]
...
set_property -dict {PACKAGE_PIN U12 IOSTANDARD LVCMOS33} [get_ports SCLK]
set_property -dict {PACKAGE_PIN V12 IOSTANDARD LVCMOS33} [get_ports ADC_D0]
set_property -dict {PACKAGE_PIN V10 IOSTANDARD LVCMOS33} [get_ports DAC_D0]
set_property -dict {PACKAGE_PIN V11 IOSTANDARD LVCMOS33} [get_ports MCLK]
set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets SCLK_IBUF]
set_property -dict {PACKAGE_PIN U14 IOSTANDARD LVCMOS33} [get_ports LRCLK]
set_property -dict {PACKAGE_PIN V14 IOSTANDARD LVCMOS33} [get_ports ADC_D1]
set_property -dict {PACKAGE_PIN T13 IOSTANDARD LVCMOS33} [get_ports DAC_D1]
set_property -dict {PACKAGE_PIN U13 IOSTANDARD LVCMOS33} [get_ports CODEC_RST]
...
set_property SLEW FAST [get_ports ADC_D0]
set_property SLEW FAST [get_ports ADC_D1]
set_property SLEW FAST [get_ports CODEC_RST]
set_property DRIVE 16 [get_ports ADC_D0]
set_property DRIVE 16 [get_ports ADC_D1]
set_property DRIVE 16 [get_ports CODEC_RST]
